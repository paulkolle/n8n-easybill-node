...
export const discountFields: INodeProperties[] = [
    ...
    /* ╚═══════════════╝ */
    {
        ...
        displayOptions: {
            show: {
                resource: ['discount'],
                operation: ['getDiscountPosition', 'updateDiscountPosition', 'deleteDiscountPosition', 'getDiscountPositionGroup', 'updateDiscountPositionGroup', 'deleteDiscountPositionGroup',],
            },
        },
    },
    /* ╔════════════════════════════════════════════════╗ */
    ...
    },
    {
        ...
        type: 'options',
        default: 'PERCENT',
        description: 'AMOUNT subtracts the value in "discount" from the total, QUANTITY subtracts the value in "discount" multiplied by quantity, PERCENT uses the value in "discount" as a percentage ,FIX sets the value in "discount" as the new price',
        options: [
            {
                name: 'Amount',
                value: 'AMOUNT'
