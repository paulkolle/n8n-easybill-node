		...
		options: [
			{
				...
				description:
					'Filter customers by additional_group_id. You can add multiple group ids separated by commas.',
			},
			{
				...
				default: '',
				description:
					'Filter customers by company_name. You can add multiple names separated by commas like name,name,name.',
			},
			{
				displayName: 'Country',
				name: 'country',
				...
				default: '',
				description:
					'Filter customers by country. You can add multiple countries separated by commas like DE,PL,FR.',
			},
			{
			...
			},
			{
				...
				default: '',
				description:
					'Filter customers by emails. You can add multiple emails separated by commas like mail,mail,mail.',
			},
			{
				...
				default: '',
				description:
					'Filter customers by first_name. You can add multiple names separated by commas like name,name,name.',
			},
			{
				...
				// eslint-disable-next-line n8n-nodes-base/node-param-description-miscased-id
				description:
					'Filter customers by group_id. You can add multiple group ids separated by commas like id,id,id.',
			},
			{
			...
			},
			{
				...
				default: '',
				description:
					'Controls the type of the customer. If "number" or "supplier_number" is empty, the type will force number generation if applicable. Available values: CUSTOMER, SUPPLIER, CUSTOMER,SUPPLIER. Default value: CUSTOMER.',
			},
			{
				...
				default: '',
				description:
					'Filter customers by zip_code. You can add multiple zip codes separated by commas like zip,zip,zip.',
			},
		],
		displayOptions: {
			show: {
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '123456789',
				description:
					'Number of the customer. If not provided, it will be generated automatically based on the type.',
			},
			{
				displayName: 'Phone 1',
				name: 'phone_1',
