...
export const documentFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'Filter documents by type. Multiple typs seperate with , like type=INVOICE,CREDIT. Available values : INVOICE, RECURRING, CREDIT, OFFER, REMINDER, DUNNING, STORNO, STORNO_CREDIT, DELIVERY, PDF, CHARGE, CHARGE_CONFIRM, LETTER, ORDER, PROFORMA_INVOICE, STORNO_PROFORMA_INVOICE',
			},
			{
	...
	/* ╚════════════════════════════════╝ */
	{
		...
		displayOptions: {
			show: {
				resource: ['document'],
				operation: ['updateDocument', 'completeDocument'],
			},
		},
	},
	/* ╔══════════════════════════════╗ */
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: 'default',
				description:
					'[ default, default_without_stationery, zugferd1, zugferd2_2, xrechnung2_2_xml, xrechnung2_3_xml, xrechnung3_0_xml ]',
			},
			{
				displayName: 'Fulfillment Country',
				name: 'fulfillment_country',
			...
			},
			{
				...
				default: false,
				description:
					"Whether a document can be accepted by the end customer through the document's public access page",
			},
			{
				displayName: 'Is Archive',
				name: 'is_archive',
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether the document is related to open source software',
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether a document is as a replica from another software',
			},
			{
				...
				options: [
					{
						...
						values: [
							...
							},
							{
								...
								type: 'boolean',
								default: false,
								description: 'Whether notification flag is set',
							},
							{
								displayName: 'Is Paid',
								name: 'is_paid',
								type: 'boolean',
								default: false,
								description: 'Whether the document is paid',
							},
							{
								displayName: 'Is SEPA',
								name: 'is_sepa',
								type: 'boolean',
								default: false,
								description: 'Whether the document is related to SEPA payment',
							},
							{
								displayName: 'Is Sign',
								name: 'is_sign',
								type: 'boolean',
								default: false,
								description: 'Whether the document requires a signature',
							},
							{
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						default: 'DEFAULT',
						description:
							"With DEFAULT no other fields are required and this message will be printed: 'Invoice date coincides with the time of supply'. For SERVICE or DELIVERY exactly one of the following fields must be set: date, date_from and date_to or text.",
					},
				],
			},
			{
			...
			},
			{
				...
				default: 'INVOICE',
				description:
					'Can only set on create. Enum: [ INVOICE, RECURRING, CREDIT, OFFER, REMINDER, DUNNING, STORNO, STORNO_CREDIT, DELIVERY, PDF, CHARGE, CHARGE_CONFIRM, LETTER, ORDER, PROFORMA_INVOICE, STORNO_PROFORMA_INVOICE ].',
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether to use the shipping address',
			},
			{
				displayName: 'VAT Country',
				name: 'vat_country',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Whether to send the document by self',
			},
			{
				...
				type: 'boolean',
				default: true,
				description: 'Whether to send the document with attachment',
			},
			{
				displayName: 'Subject',
				name: 'subject',
	...
	/* ╚════════════════════╝ */
	{
		...
		required: true,
		description:
			'Available values : DUNNING, REMINDER, CHARGE_CONFIRM, CHARGE, CREDIT, DELIVERY, INVOICE, ORDER',
		displayOptions: {
			show: {
